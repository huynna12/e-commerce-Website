...
# In production, serve collected static files efficiently.
if not DEBUG:
...
# --- Optional security hardening (recommended in production) ---
# Keep these OFF by default to avoid breaking local development.
